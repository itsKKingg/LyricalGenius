  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInError) {
        ...
        // Successfully signed in, redirect to editor
        router.push("/editor");
      }
    } catch (err) {
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">
              Sign in to continue to LyricalGenius
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
