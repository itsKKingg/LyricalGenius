...
export default function AuthErrorContent() {
  ...
  useEffect(() => {
    ...
    if (error && errorDescription) {
      ...
      setErrorDetails("An authentication error occurred");
    }
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-8">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>
                    We encountered an issue while trying to authenticate your account. This could be due to:
                  </p>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                    <li>Invalid or expired authentication credentials</li>
                    <li>Network connection problems</li>
                    <li>Account security restrictions</li>
                    <li>Third-party authentication service issues</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-500">
              Need help? Try clearing your browser cache or contact our support team.
            </p>
          </div>
        </div>
