...
export const TextEditorView: React.FC = () => {
  return (
    <div className="p-8 max-w-[1600px] mx-auto animate-fade-in h-[calc(100vh-64px)]">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Clipper</h1>
        <p className="text-slate-500 dark:text-slate-400">Advanced clipping and segmentation tools.</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center h-96 text-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50/50 dark:bg-slate-900/20">
         ...
         <p className="text-slate-900 dark:text-white font-medium mb-1">Clipper is empty</p>
         <p className="text-sm text-slate-500 dark:text-slate-400">Select media to start clipping.</p>
      </div>
    </div>
  );
};